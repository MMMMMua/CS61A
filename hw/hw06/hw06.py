...
def make_withdraw(balance, password):
    ...
    "Your account is locked. Attempts: ['hwat', 'a', 'n00b']"
    """
    def withdraw(amount, user_password, error_pass=[]):
        nonlocal balance
        if len(error_pass) < 3:
            if user_password == password:
                ...
                error_pass += [user_password]
                return 'Incorrect password'
        return "Your account is locked. Attempts: {0}".format(error_pass)
    return withdraw
...
class MissManners:
    ...
    def ask(self, message, *args):
        ...
        string_post_str = message.partition(magic_word)[2]
        if hasattr(self.obj, string_post_str):
            return getattr(self.obj, string_post_str)(*args)
        else:
            return 'Thanks for asking, but I know not how to {}.'.format(string_post_str)
